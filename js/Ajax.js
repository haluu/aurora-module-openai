...
Ajax.registerAbortRequestHandler(Settings.ServerModuleName, function (oRequest, oOpenedRequest) {
	...
	switch (oRequest.Method)
	{
		...
		case 'GetOpenAIResponse':
			// Allow concurrent AI requests but abort duplicate ones
			return oOpenedRequest.Method === oRequest.Method && 
				   JSON.stringify(oParameters) === JSON.stringify(oOpenedParameters);
	}
